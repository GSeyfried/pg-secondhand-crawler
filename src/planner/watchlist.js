...
export function matchWatchItem(listing,watch) {
  ...
  if(watch.requireInspectionReport&&!/\b(?:inspect(?:ed|ion)|trim(?:med| check)|service report)\b/i.test(listing.description??''))manual.push('inspection report not documented');
